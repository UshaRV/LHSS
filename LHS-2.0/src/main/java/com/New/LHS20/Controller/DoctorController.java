...
//    
	...
	// Doctor can fetch List of appointments for doctor using doctor id
	...
	// Both patients and Admin can fetch all the doctors with speciality
	@GetMapping("/getspeciality")
	public List<Speciality> getspecaility() {
		return specialityRepository.findAll();
	}

	// Patient can able to fetch the doctors details with speciality
